...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const raid_name = interaction.options.getString('raid_name');
        ...
        const raid_size = interaction.options.getInteger('raid_size') || 'Max: 8';

        let embed = new EmbedBuilder()
            .setTitle(`Raid: ${raid_name}`)
            .setDescription('Raid Created')
            .setColor(0x00AE86)
            .addFields(
                { name: 'Description', value: description },
                { name: 'Gameplay_Type', value: gameplayType, inline: true },
                { name: 'Raid_Size', value: raid_size.toString(), inline: false },
